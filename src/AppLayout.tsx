...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  const routeBackground = useMemo(() => {
    ...
    if (location.pathname === "/gym" || location.pathname === "/") return gymImages.gymHeroMultan;
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div className="absolute inset-0">
        ...
        {/* Clean industrial overlays (no "boxed" columns) */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0)_0%,rgba(0,0,0,0.55)_55%,rgba(0,0,0,0.82)_100%)]" />
